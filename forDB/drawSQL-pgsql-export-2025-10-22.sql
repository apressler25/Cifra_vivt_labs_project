CREATE TABLE "Workout_exercises"(
    ...
    "id_creation_user" VARCHAR(255) NOT NULL,
...
CREATE TABLE "Approaches_rec"(
    ...
    "rest_time_num_approaches_rec" BIGINT NULL,
...
ALTER TABLE
    "Programs_workout" ADD CONSTRAINT "programs_workout_id_user_foreign" FOREIGN KEY("id_user") REFERENCES "User"("id_user");
ALTER TABLE
    "Restrictions" ADD CONSTRAINT "restrictions_id_user_foreign" FOREIGN KEY("id_user") REFERENCES "User"("id_user");
ALTER TABLE
...
ALTER TABLE
    "Train_pool" ADD CONSTRAINT "train_pool_id_ex_pool_foreign" FOREIGN KEY("id_ex_pool") REFERENCES "Workout_ex_pool"("id_ex_pool");
ALTER TABLE
