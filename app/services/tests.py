...
# }
    ...
    workout_exercises = [
        ...
        WorkoutExercises( name_workout_exercises="Приседания со штангой", id_creation_user=1, 
        ...
        WorkoutExercises( name_workout_exercises="Выпады с гантелями", id_creation_user=1, 
        ...
        WorkoutExercises(name_workout_exercises="Жим штанги лежа", id_creation_user=1, 
        ...
        WorkoutExercises(name_workout_exercises="Разведение гантелей лежа", id_creation_user=1, 
        ...
        WorkoutExercises(name_workout_exercises="Подтягивания широким хватом", id_creation_user=1, 
        ...
        WorkoutExercises(name_workout_exercises="Молотки с гантелями", id_creation_user=1, 
        ...
        WorkoutExercises(name_workout_exercises="Скручивания на пресс", id_creation_user=1, 
        ...
        WorkoutExercises( name_workout_exercises="Жим штанги с подъемом головы", id_creation_user=1, 
        ...
        WorkoutExercises(name_workout_exercises="Тяга к подбородку с напряжением шеи", id_creation_user=1, 
        ...
        WorkoutExercises( name_workout_exercises="Подъем штанги на бицепс с супинацией", id_creation_user=1, 
        ...
        WorkoutExercises( name_workout_exercises="Молотковые сгибания с гантелями", id_creation_user=1, 
        ...
        WorkoutExercises( name_workout_exercises="Шраги со штангой за спиной", id_creation_user=1, 
        ...
        WorkoutExercises( name_workout_exercises="Тяга лица на блоке", id_creation_user=1, 
        ...
        WorkoutExercises( name_workout_exercises="Приседания в тренажере Смита", id_creation_user=1, 
        ...
        WorkoutExercises( name_workout_exercises="Жим ногами с узкой постановкой", id_creation_user=1, 
        ...
        WorkoutExercises( name_workout_exercises="Выпады в тренажере Смита", id_creation_user=1, 
        ...
        WorkoutExercises( name_workout_exercises="Тяга штанги к подбородку широким хватом", id_creation_user=1, 
        ...
        WorkoutExercises( name_workout_exercises="Приседания сумо", id_creation_user=1, 
        ...
        WorkoutExercises(name_workout_exercises="Сведения ног в тренажере", id_creation_user=1, 
        ...
        WorkoutExercises( name_workout_exercises="Боковые выпады с гантелями", id_creation_user=1, 
        ...
        WorkoutExercises( name_workout_exercises="Румынская тяга со штангой", id_creation_user=1, 
        ...
        WorkoutExercises( name_workout_exercises="Сгибания ног лежа", id_creation_user=1, 
        ...
        WorkoutExercises( name_workout_exercises="Гудмонинги (Good Mornings)", id_creation_user=1, 
        ...
        WorkoutExercises(name_workout_exercises="Боковые скручивания на римском стуле", id_creation_user=1, 
        ...
        WorkoutExercises( name_workout_exercises="Русские скручивания с диском", id_creation_user=1, 
        ...
        WorkoutExercises( name_workout_exercises="Боковые наклоны с гантелью", id_creation_user=1, 
        ...
        WorkoutExercises( name_workout_exercises="Тяга гантели в наклоне", id_creation_user=1, 
        ...
        WorkoutExercises(name_workout_exercises="Тяга Т-грифа", id_creation_user=1, 
        ...
        WorkoutExercises( name_workout_exercises="Пуловер с гантелью лежа", id_creation_user=1, 
